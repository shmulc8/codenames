...
python skills/codenames-deploy/deploy.py

# or name the changed files explicitly (paths relative to hf_space/)
python skills/codenames-deploy/deploy.py probe.py app.py data/word2root.json
```
...
```bash
python skills/codenames-qa/verify_live.py
```
