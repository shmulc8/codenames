...
> **Read `SKILL.md`, `ui-changes.md` and `missing-ui-gaps.md` (in `uploads/`) alongside this.** They carry the game rules and the full change rationale. This doc is the *design decisions*; those are the *requirements*.
